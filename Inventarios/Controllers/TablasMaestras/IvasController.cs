...
namespace Inventarios.Controllers.TablasMaestras
{
    ...
    public class IvasController : ControllerBase
    {
        ...
        public IvasController(IvasService service, Validaciones validaciones)
        {
            _service = service;
        ...
        [HttpPost]
        [ActionName("Add")]
        public Mensaje Add(Ivas obj, int idusuario, string token)
        {
        ...
        [HttpPut]
        [ActionName("Update")]
        public Mensaje Update(Ivas obj, int idusuario, string token)
        {
            if (_validaciones.ValidarToken(idusuario, token) == false) return null;
        ...
        [ActionName("GetById")]
        public List<Ivas>? GetById(int id, int idusuario, string token)
        {
            if (_validaciones.ValidarToken(idusuario, token) == false) return null;
        ...
        [ActionName("GetAll")]
        public List<IvasDTO>? GetAll(string filtro, int idusuario, string token )
        {
